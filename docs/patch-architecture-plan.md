...
|------|------|------|---------------|
| (no flags) | Recommended set: ClinVar + SnpEff DB + GWAS Catalog | ~1.8 GB | ~5-10 min |
| `--gnomad` | Also gnomAD v4 exome VCFs (per-chrom) | +8 GB | +20-40 min |
| `--dbsnp` | Also dbSNP VCF | +20 GB | +30-60 min |

...
This was discovered during PR #25 (documentation cleanup) when the user asked why `genechat annotate --dbsnp` said "manual download required" despite the plan specifying automated download.

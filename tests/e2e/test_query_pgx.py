...
class TestQueryPgxGIAB:
    def test_simvastatin_slco1b1(self, giab_engine, giab_db, giab_config):
    ...
    def test_warfarin_vkorc1(self, giab_engine, giab_db, giab_config):
    ...
    def test_codeine_cyp2d6(self, giab_engine, giab_db, giab_config):
        """Codeine query should show CYP2D6 variants."""
        fn = _get_tool(giab_engine, giab_db, giab_config)
        result = fn(drug="codeine")
        assert "CYP2D6" in result

    def test_gene_lookup(self, giab_engine, giab_db, giab_config):
    ...
    def test_unknown_drug(self, giab_engine, giab_db, giab_config):
    ...
    def test_pgx_output_has_genotypes(self, giab_engine, giab_db, giab_config):

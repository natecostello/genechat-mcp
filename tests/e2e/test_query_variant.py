...
class TestQueryVariantGIAB:
    @pytest.mark.slow
    def test_rsid_het_variant(self, giab_engines, giab_db, giab_config):
    ...
    @pytest.mark.slow
    def test_rsid_absent_variant(self, giab_engines, giab_db, giab_config):
    ...
    def test_query_by_position(self, giab_engines, giab_db, giab_config):
    ...
    def test_no_input_returns_help(self, giab_engines, giab_db, giab_config):

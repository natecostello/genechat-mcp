...
class TestQueryPgx:
    def test_drug_lookup(self, mock_engine, mock_engines, test_db, test_config):
    ...
    def test_gene_lookup(self, mock_engine, mock_engines, test_db, test_config):
        from tests.conftest import SAMPLE_VARIANT_SLCO1B1
    ...
    def test_unknown_drug(self, mock_engine, mock_engines, test_db, test_config):
        fn = _setup_tool(mock_engines, test_db, test_config)

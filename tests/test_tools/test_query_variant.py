...
class TestQueryVariant:
    def test_rsid_found(self, mock_engine, test_db, test_config):
    ...
    def test_rsid_not_found(self, mock_engine, test_db, test_config):
    ...
    def test_position_lookup(self, mock_engine, test_db, test_config):
        from tests.conftest import SAMPLE_VARIANT_SLCO1B1
...
class TestQueryVariantClinvar:
    def test_clinvar_shown(self, mock_engine, test_db, test_config):

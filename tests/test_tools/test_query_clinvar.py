...
class TestQueryClinvar:
    def test_pathogenic_found(self, mock_engine, mock_engines, test_db, test_config):
    ...
    def test_no_results(self, mock_engine, mock_engines, test_db, test_config):
    ...
    def test_with_gene_filter(self, mock_engine, mock_engines, test_db, test_config):
        from tests.conftest import SAMPLE_VARIANT_CFTR

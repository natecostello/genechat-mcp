...
class TestQueryGene:
    def test_gene_with_variants(self, mock_engine, mock_engines, test_db, test_config):
    ...
    def test_unknown_gene(self, mock_engine, mock_engines, test_db, test_config):
        fn = _setup_tool(mock_engines, test_db, test_config)
        result = fn(gene="FAKEGENE123")
        assert "not found" in result

    def test_no_variants(self, mock_engine, mock_engines, test_db, test_config):
...
class TestSmartFilter:
    def test_common_benign_suppressed(
        self, mock_engine, mock_engines, test_db, test_config
    ):
    ...
    def test_rare_variant_kept(self, mock_engine, mock_engines, test_db, test_config):
    ...
    def test_high_impact_never_suppressed(
        self, mock_engine, mock_engines, test_db, test_config
    ):
    ...
    def test_no_af_clinvar_only_fallback(
        self, mock_engine, mock_engines, test_db, test_config
    ):
    ...
    def test_smart_filter_false_shows_all(
        self, mock_engine, mock_engines, test_db, test_config
    ):
    ...
    def test_known_pgx_rsid_never_suppressed(
        self, mock_engine, mock_engines, test_db, test_config
    ):
    ...
    def test_clinvar_benign_common_suppressed(
        self, mock_engine, mock_engines, test_db, test_config
    ):

...
class TestGenomeSummary:
    def test_basic_summary(self, mock_engine, mock_engines, test_db, test_config):
    ...
    def test_variant_counts(self, mock_engine, mock_engines, test_db, test_config):
        mock_engine.stats.return_value = {
            "total_variants": 5000,
            "SNPs": 4000,
            "indels": 1000,
    ...
    def test_clinvar_pathogenic(self, mock_engine, mock_engines, test_db, test_config):
    ...
    def test_pgx_section(self, mock_engine, mock_engines, test_db, test_config):
        mock_engine.stats.return_value = {"total_variants": 100}
        mock_engine.query_clinvar.return_value = []
        mock_engine.query_region.return_value = []
        fn = _setup_tool(mock_engines, test_db, test_config)
    ...
    def test_pgx_nonref_found(self, mock_engine, mock_engines, test_db, test_config):
    ...
    def test_annotation_versions_displayed(
    ...
    def test_annotation_versions_empty(
        self, mock_engine, mock_engines, test_db, test_config
    ):
        mock_engine.annotation_versions.return_value = {}
        mock_engine.stats.return_value = {"total_variants": 100}
    ...
    def test_tool_suggestions(self, mock_engine, mock_engines, test_db, test_config):
        mock_engine.stats.return_value = {"total_variants": 100}
        mock_engine.query_clinvar.return_value = []
        mock_engine.query_region.return_value = []
        fn = _setup_tool(mock_engines, test_db, test_config)

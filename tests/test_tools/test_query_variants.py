...
class TestQueryVariants:
    def test_batch_found(self, mock_engine, mock_engines, test_db, test_config):
    ...
    def test_partial_found(self, mock_engine, mock_engines, test_db, test_config):
    ...
    def test_none_found(self, mock_engine, mock_engines, test_db, test_config):
        mock_engine.query_rsids.return_value = {
            "rs9999999": [],
        }
        fn = _setup_tool(mock_engines, test_db, test_config)
    ...
    def test_too_many(self, mock_engine, mock_engines, test_db, test_config):
        fn = _setup_tool(mock_engines, test_db, test_config)
